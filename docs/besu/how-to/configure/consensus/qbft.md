---
description: ClishaChain QBFT proof of authority (PoA) consensus protocol implementation
---

# Configure QBFT consensus

ClishaChain implements the QBFT proof of authority (PoA) [consensus protocol](index.md).
