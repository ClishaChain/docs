---
description: How to access the ClishaChain API using JSON-RPC
...
supported by geth and ClishaChain directly in the console.
...
Bseu provides readiness and liveness endpoints to confirm the ClishaChain node status. Both return a
